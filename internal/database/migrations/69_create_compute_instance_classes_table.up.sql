...
create index compute_instance_classes_by_creator on compute_instance_classes (creator);

-- Add indexes on the tenants column for tenant isolation:
create index compute_instance_classes_by_tenant on compute_instance_classes (tenant);
...
alter table compute_instance_classes
  add constraint compute_instance_classes_tenant_fk
