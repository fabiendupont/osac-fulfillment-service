...
type ComputeInstanceTemplate struct {
	...
	RoleCollection string `protobuf:"bytes,10,opt,name=role_collection,json=roleCollection,proto3" json:"role_collection,omitempty"`
...
func (b0 ComputeInstanceTemplate_builder) Build() *ComputeInstanceTemplate {
	...
	x.Site = b.Site
	x.Role = b.Role
	x.RoleCollection = b.RoleCollection
	return m0
}
